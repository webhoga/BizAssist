    ...
    meta: [
        {
            name: 'description',
            content:
                'Professional business consultation at ₹2,499 per session. 60-minute expert advisory for startups & growing businesses. Strategic planning, financial advice, marketing & operations. Book now.',
        },
        {
            name: 'keywords',
            content:
                'business consultation, business advisor, business consultant India, startup consultation, business coaching, strategic planning, business growth consultant, small business advisor, expert business advice',
        },
    ],
};
        ...
        <div class="min-h-screen bg-gray-50">
            ...
            <section class="bg-gradient-to-br from-indigo-600 to-indigo-700 text-white py-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl">
                        ...
                        <p class="text-lg sm:text-xl mb-8 text-indigo-50 leading-relaxed">
                            Get expert guidance to grow your business, solve challenges, and make strategic decisions.
                            One-on-one consultation with experienced business advisors
                        </p>
                        ...
                        <a
                            ...
                            class="bg-white text-indigo-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold text-lg shadow-lg inline-block"
                        >
                            Book Consultation
                        </a>
                    </div>
            ...
            <section class="py-16 sm:py-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 class="text-3xl sm:text-4xl font-bold text-gray-800 mb-4 text-center">
                        Why Choose Our Business Consultation?
                    </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-indigo-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Get advice from experienced business consultants with proven track records
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-indigo-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Develop effective strategies for growth, expansion, and market positioning
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-indigo-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Optimize cash flow, reduce costs, and improve profitability with expert advice
                            </p>
                        </div>

                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-purple-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Improve team productivity, hiring strategies, and operational efficiency
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-purple-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Build effective marketing campaigns and customer acquisition strategies
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-purple-600">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Identify and mitigate business risks before they impact your bottom line
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="bg-white py-16 sm:py-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                        Comprehensive business consultation across all areas
                    </p>
                            ...
                            <div class="space-y-4">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        desc: 'Identify profit leaks and improve margins',
                                    },
                                    {
                                        title: 'Team Building',
                                        desc: 'Build high-performing teams and improve culture',
                                    },
                                    {
                        ...
                        <div class="space-y-8">
                            {[
                                ...
                                <div key={step.num} class="flex gap-6">
                                    <div class="flex-shrink-0">
                                        <div class="w-16 h-16 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg">
                                            {step.num}
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <div class="bg-gray-50 rounded-2xl shadow-lg p-8">
                            ...
                            <div class="space-y-3 mb-8 text-left text-sm">
                                {['60-minute consultation', 'Expert advisor', 'Action plan document'].map(
                                    (feature, idx) => (
                            ...
                            <a
                                href="https://webhoga.com/contact"
                                class="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 font-semibold inline-block text-center"
                            >
                                Book Now
                            </a>
                        </div>
                        ...
                        {/* 3-Session Package */}
                        <div class="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl shadow-2xl p-8 text-white relative transform scale-105">
                            <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-gray-900 px-4 py-1 rounded-full text-xs font-bold">
                                MOST POPULAR
                            </div>
                            ...
                            <a
                                href="https://webhoga.com/contact"
                                class="w-full bg-white text-indigo-600 px-6 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold inline-block text-center"
                            >
                                Book Package
                            </a>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="bg-white p-8 rounded-xl shadow-lg">
                            ...
                            <p class="text-gray-600 mb-4 leading-relaxed">
                                "Best investment for my startup! The funding strategy session helped me secure seed
                                funding. The advisor was knowledgeable and practical."
                            </p>
                        ...
                        <div class="bg-white p-8 rounded-xl shadow-lg">
                            ...
                            <p class="text-gray-600 mb-4 leading-relaxed">
                                "Took the 5-session package and it was worth every rupee. My restaurant's profit margin
                                improved by 25%. Thank you BizAssist!"
                            </p>
            ...
            <section class="py-16 sm:py-20 bg-gradient-to-br from-indigo-50 to-indigo-100">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                        Expert consultation across diverse sectors
                    </p>
            ...
            <section class="py-16 sm:py-20 bg-white">
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p class="text-center text-gray-600 mb-12">
                        Everything you need to know about our consultation
                    </p>
                    <div class="space-y-6">
                        {[
                            {
            ...
            <section id="contact" class="bg-indigo-600 py-16 sm:py-20">
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p class="text-lg sm:text-xl text-indigo-100 mb-8">
                        Book a consultation session and get expert guidance tailored to your needs
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="https://webhoga.com/contact"
                            class="bg-white text-indigo-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300 font-bold text-lg shadow-lg inline-block"
                        >
                            Book Now - ₹2,499
                        </a>
                        <a
                            href="https://webhoga.com/contact"
                            class="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 font-semibold text-lg inline-block"
                        >
                            View Packages
                        </a>
                    </div>
